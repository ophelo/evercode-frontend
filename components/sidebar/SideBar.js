...
const SideBar = () => {    
    ...
    return (
        <div className=" flex flex-col fixed left-0 top-0 w-20 h-screen bg-gray-700 shadow-md justify-start">
            <Link href="/">
            ...
            <SideBarButton  icon={<FcSettings size={28}/>} handler={()=>setOpen(!open)} state={open}/>
            <Settings open={open}/>
        </div>
    );
}
