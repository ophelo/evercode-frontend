...
export default function ReqCard({ random, id, accessToken, setDisable }) {

  return (
      <div className="w-full shadow-sm rounded-lg border-solid border-2 border-gray-400">
        <div className="overflow-hidden">
          <img className="h-full w-full object-fill" src={"https://picsum.photos/200/200?random="+random} alt=""/>
        </div>
        <div className="px-2 pt-2 font-bold">{random}</div>
